...
impl ControllerReferenceLayout {
    fn for_image(image_width: u32, image_height: u32) -> Self {
        ...
        Self {
            left_stick: circle(209.0, 190.0, 27.0),
            right_stick: circle(486.0, 295.0, 27.0),
            stick_cursor_range: 22.0 * scale,
            stick_cursor_radius: 4.0 * scale,
            dpad_up: circle(300.0, 262.0, 10.0),
            dpad_down: circle(300.0, 329.0, 10.0),
            dpad_left: circle(267.0, 296.0, 10.0),
            dpad_right: circle(334.0, 296.0, 10.0),
