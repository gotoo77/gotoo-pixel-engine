use gotoo_pixel_engine::{
    ...
    ui::{
        UiTheme,
        experimental::{self, UiGridSpec, UiInput, UiNavInput, UiPointerInput, UiStateStore},
    },
};
        ...
        self.paint(
            ...
            UiInput {
                ...
                nav: UiNavInput {
                    ...
                    left: !self.search.active && frame.input.key(Key::Left).pressed(),
                    right: !self.search.active && frame.input.key(Key::Right).pressed(),
                    confirm: !was_active
                        && !self.search.active
