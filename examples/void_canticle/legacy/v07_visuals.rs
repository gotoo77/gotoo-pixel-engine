...
impl PilgrimV07Visuals {
    fn new() -> Self {
        ...
        // VC art pass: the Pilgrim is a reliquary-vessel rather than a generic
        // little ship. Gold reads as sacred framing, violet as the Canticle
        // core, and the narrow lower spine keeps the collision center obvious.
    ...
    fn render(
        ...
        if focused {
            // Keep the hit-point readable without wrapping the whole vessel in
            // a large HUD-like circle.
            framebuffer.draw_circle(x, y - 1, 3, PILGRIM_GOLD);
